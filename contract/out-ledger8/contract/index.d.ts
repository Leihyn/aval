...
export type ImpureCircuits<PS> = {
  register_attestor(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, []>;
...
export type Circuits<PS> = {
  derive_id(context: __compactRuntime.CircuitContext<PS>, sk_0: Uint8Array): __compactRuntime.CircuitResults<PS, Uint8Array>;
