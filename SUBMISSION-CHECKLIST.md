...
- [ ] **Demo / video pitch**
- [ ] Description of progress completed during Wave 1

## Registration prerequisites

- [ ] Registered on AKINDO and joined this Buildathon page
- [ ] Every team member registered individually (solo entry: just the one)
...
|---|---|---|
| 40% | Engineering & Implementation | Compact contract compiles; private state via witnesses; dual-ledger understanding shown through explicit `disclose()` boundaries; organized repo; clear README |
| 15% | Quality Assurance & Reliability | Simulation + test files present **and passing** |
| 15% | Product & Vision | Idea soundness, connection to Midnight core capabilities, **realistic** scope and roadmap |
| 15% | User Experience & Design | Frontend intuitive, connects to contract, functional end to end |
| 10% | Communication | Video + slide deck clarity |
| 5% | Business Development & Viability | Target audience, market, adoption path |

## Grant mechanics (sets expectations, not effort)
...
- [ ] Repo is public and loads in a logged-out browser
- [ ] README renders correctly on GitHub (check the rendered page, not the raw file)
- [ ] Video plays from a logged-out browser at the shared link
- [ ] Deck opens from a logged-out browser at the shared link
- [ ] Every URL in the submission opened in a private window and confirmed
- [ ] Submitted with >60 min to spare (platform load spikes at the deadline)
