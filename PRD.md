...
2. 24 tests pass in roughly one second. No Docker, no proof server, no wallet.
...
| Tests must pass from clean clone | [I] | Section 7.5 60-second test; 24 tests currently pass. |
